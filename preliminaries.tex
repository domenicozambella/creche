...
The languages in Examples~\ref{LgaLgmLau} and \ref{linguaggio_spazi_vettoriali}, with the exception of that of ordered rings, are \emph{functional languages;}\index{language!functional} that is, $L_{\rm rel}=\0$. The following example mention two important examples of \emph{relational languages,}\index{language!relational} that is, languages where $L_{\rm fun}=\0$.
