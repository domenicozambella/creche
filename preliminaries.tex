...
\begin{itemize}
\item[1.] a set \emph{$L_{\rm\bf fun}$}\index{0Lfun@$L_{\rm fun}$} whose elements are called \emph{function symbols}\index{symbol!function}.
\item[2.] a set \emph{$L_{\rm\bf rel}$\/}\index{0Lrel@$L_{\rm rel}$} whose elements are called \emph{relation symbols}\index{symbol!relation}.
