...
\end{itemize}
(Condition \ssf{2} is usually obtained ensuring the inconsistency of $\phi_{s0}\wedge\phi_{s1}$ for all $s\in2^{<\omega}$.) We may depict a binary tree of formulas as follows
