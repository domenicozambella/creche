...
\def\qfDelta{\smash{\Delta\kern-.4ex\raisebox{1ex}{\scriptsize qf}}\kern-.1ex}
...
\hrulefill\par
\footnotesize
Disclaimer: these notes have come to be~--~and are constantly evolving~--~as a piece of software.
As such, they do \textit{not\/} contain \textit{errors}~--~just a few \textit{bugs.}
Bug fixes are frequent, and regularly major updates with new bugs are released.
Incidentally, these bugs have an important pedagogical value: nothing should be trusted and everything has to be critically verified.
