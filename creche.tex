...
\def\nonforkc{\mathbin{\raise1.3ex\rlap{\kern1.3ex$\cdot$}\raise0.6ex\rlap{\kern0.85ex$\vert$}\raise-0.3ex\hbox{$\smile$} } }
...
\begin{document}
\raggedbottom
\renewcommand{\contentsname}{A Cr\`eche Course in Model Theory\\[3ex] \normalfont\normalsize Domenico Zambella\vskip-1ex Università di Torino\vskip-1ex \monthname\ \the\year}
\tableofcontents
\subfile{preface}
