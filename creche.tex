...
\renewcommand*{\emph}[1]{%
\smash{\tikz[baseline]\node[rectangle, fill=red!15!yellow!50!white, rounded corners, inner xsep=0.2ex, inner ysep=0.2ex, anchor=base, minimum height = 2.7ex]{#1};}}
...
\addcontentsline{toc}{chapter}{Table of contents\\[-1.5ex]}
A Cr\`eche Course in Model Theory\\[3ex]%
\parbox{\textwidth}{\normalfont\normalsize
Domenico Zambella\\
Università di Torino\\
ORCID:~\href{https://orcid.org/0000-0003-1141-2898}{0000-0003-1141-2898}\\[1ex]
\texttt{Branch:\ \branch\ \DTMnow}}}
\tableofcontents
% \subfile{preface}
