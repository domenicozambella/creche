...
\begin{document}
\raggedbottom
\renewcommand{\contentsname}{A Cr\`eche Course in Model Theory\\[2ex] \normalfont\large Domenico Zambella\vskip-1ex Università di Torino\vskip-1ex \monthname\ \the\year}
\tableofcontents
\subfile{preface}
