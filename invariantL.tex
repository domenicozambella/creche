...
\begin{definition}\label{def_Lascar_type}We write \emph{$a\stackrel{\smash{\scalebox{.5}{\rm\bf L}}}{\equiv}_Ab$\/} and say that ${\gr a}$ and ${\gr b}$ have the same \emph{Lascar strong type over $A$\/} if the equivalence ${\gr a}\in\grD\iff{\gr b}\in\grD$ holds for every set $\grD$ that is Lascar invariant over $A$ or, in other words, if $\Ll({\gr a}/A)=\Ll({\gr b}/A)$. The notation ${\gr a}E_{_{L/A}}{\gr b}$ or ${\rm L{\jj}stp}({\gr a}/A)={\rm L{\jj}stp}({\gr b}/A)$ is also common in the the literature.\QED
\end{definition}
