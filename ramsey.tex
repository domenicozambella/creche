...
%
It is easy to verify that ${\mr\Aa'}$ is type-definable over $A,{\mr b}$ and 
idempotent.
%
It is also easy to verify that it is invariant over $M$,
hence type-definable over $M$.
%
By minimality ${\mr\Aa'}=\mrA$, and therefore ${\mr b}\in{\mr\Aa'}$.
%
Then ${\mr b}\cdot_{\!M}{\mr b}={\mr b}$ by the definition of ${\mr\Aa'}$.
%
Hence ${\mr b}$ has idempotent orbit, then by minimality $\mrA={\mr b}_M$.
\end{proof}
