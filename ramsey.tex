...
\begin{exercise}\label{ex_Ramsey_order}
  ...
  Let $f$ be a coloring of the subsets of $I$ of cardinality $n$.
...
\begin{proof}
  ...
  Then the set $\mrA\cdot_M{\mr b}$ is defined by the type $q({\mr y})=\E {\mr x},{\mr z}\ \big[ {\mr y}={\mr x}{\cdot}{\mr z}\ \wedge\ {\mr x}\in\mrA \ \wedge\ p({\mr x}\,;{\mr z})\big]$.
\end{proof}
