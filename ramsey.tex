...
it is immediate that ${\mr a_{\restriction H}}$ reøalizes \ssf{\#}
as required.
\end{proof}
...
\begin{exercise}
  ...
  Prove that $u*\C$ is a minimal right ideal of $\C$.
\end{exercise}
...
\begin{exercise}
  ...
  The isomorphism is given by the map ${\mr a}\mapsto v*{\mr a}$ with inverse ${\mr a}\mapsto u*{\mr a}$ works if we can assume that ${\mr u}$ and ${\mr v}$ such that ${\mr v}*{\mr u}={\mr v}$ and ${\mr v}*{\mr u}={\mr u}={\mr v}$.
\end{exercise}
