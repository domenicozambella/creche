...
\begin{exercise}\label{ex_symmetry_ind}
  ...
  Prove that there is an indiscernible sequence $\<{\mr d_i}:i<\omega\>$ such that ${\mr d_0},{\mr d_1}= {\mr c_1},{\mr c_0}$.\QED
\end{exercise}

\begin{exercise}
  Let $\<\D_i:i<\omega\>$ be an $A$-indiscernible sequence in $\U^\eq$.
  Prove that there is an $A$-indiscernible sequence $\<b_i:i<\omega\>$ and a formula $\phi(x\,;z)\in L$ such that $\D_i=\phi(\U\,;b_i)$.\QED
\end{exercise}
...
As observed in Remark~\ref{rk_coheir_stationary}, 
this makes $\cnonfork_G$ trivially stationary.
