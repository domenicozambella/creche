...
In this and the next section we abbreviate $\O({\mr a}/M)$, 
...
\ceq{\hfill\mrA\cdot_M\big(\mrB\cdot_M\mrC\big)}
{\subseteq}
...
% also  $\mrA\cdot_M\mrB$ is a left-ideal.
\end{corollary}
\begin{proof}
We check that if $\mrA$ is idempotent so is $\mrA\cdot_M\mrB$

\ceq{\hfill\big(\mrA\cdot_M\mrB\big)\ \cdot_M\ \big(\mrA\cdot_M\mrB\big)}
    {\subseteq}
...
% if $\mrW\cdot_M{\mr a}$, i.e.\@ the left-ideal generated by the orbit of ${\mr a}$, is minimal among the type-definable left-ideals.
