...
Let ${\mr\Aa'}\subseteq\mrA$ be minimal among the type-definable idemponent sets such that ${\mr b}\in{\mr\Aa'}\cdot_{\!M}{\mr b}$. 
Let ${\mr a}\in{\mr\Aa'}$ be such that ${\mr a}\cnonfork_M{\mr b}$ and ${\mr a}{\cdot}{\mr b}={\mr b}$.
By associativity, $\big({\mr a}\cdot_{\!M}{\mr a}\big)\cdot_{\!M}{\mr b}={\mr b}_M$.
Therefore is ${\mr a}_M$ idempotent.
By minimality ${\mr a}_M={\mr\Aa'}=\mrA={\mr b}_M$.
\end{proof}
