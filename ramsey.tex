...
there is a ${\mr v}\in\big({\mr a}\cdot_G\mrV\big)\cap\big(\mrV\cdot_G{\mr a}\big)$ 
with idempotent orbit.
We can further require that ${\mr v}\in\mrV\sm\mrU$ 
(in the proof of claim \ssf{1}, with $\mrV$ for $\mrU$, apply nicety to show that we can choose ${\mr c}\in\mrV\sm\mrU$).
...
For every $a\in F$ the map $\sigma_a:t(x)\mapsto t(a)$ is a retraction.
