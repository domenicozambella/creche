...
\item \hyperref[newelski]{Newelski's Theorem\/} on the diameter of Lascar types is proved in an elementary self-contained way. (Admittedly, it is difficult to justify the inclusion of this theorem in an introductory course.)
\item  \hyperref[external]{Stability\/} is equated to definability of externally definable sets. Externally definable sets are identified with \textit{approximable sets}. This chapter was intentionally kept short. It may be too short though.   
\end{itemize}
\end{document}
