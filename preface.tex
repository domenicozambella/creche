...
\item  In the last chapter we briefly introduce \hyperref[external]{stability and NIP}. We only discuss the properties of externally definable sets, which we identify with \textit{approximable sets}.
\end{itemize}
\end{document}
