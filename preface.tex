...
\item We are all used to \noindent\emph{syntax highlighting\/} in a {\mr\TeX\ source file}, but it looks strange in a {\gr text of math}. There are good reasons: it is difficult to be coherent; it is easy to offend the eye. But I have not used this as an excuse for not trying. 
\end{itemize}
\end{document}
