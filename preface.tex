...
%\item \noindent\emph{Color coding\/} looks strange in a text of math. There are good reasons: it is difficult to be {\gr coherent}; it is easy to be {\mr eye-o}{\gr ffend}{\mr ing}. These notes may contain a few examples. 
\end{itemize}
\end{document}
