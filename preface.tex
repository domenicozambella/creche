...
\item \noindent\emph{Syntax highlighting\/} is the norm when writing in {\mr\TeX}. But it looks strange in a {\gr text of math}. There are good reasons: it is difficult to be coherent; it is easy to be eye offending. But I have not used this as an excuse for not trying. 
\end{itemize}
\end{document}
