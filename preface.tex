...
\item \hyperref[Ramsey]{Ramsey's Theorem} is derived from the existence of coheir sequences. This is not the shortest proof, but it should be interesting.
\item Along the same lines we sketch a proof of \hyperref[Hindman]{Hindman's Theorem} which based on coheir sequences and uniqueness of coheir extensions.
