...
% \noindent\llap{\textcolor{red}{\Large\danger}\kern1.5ex}Warning: the terminology introduced in this section is non-standard.
...
(Assume~\ref{ass_c1-6})  All rich models of cardinality $\lambda$ in the same connected component are isomorphic.\QED
\end{corollary}
...
Let $\lambda\ge|L|$ be given. The \emph{theory of the rich models\/} of $\M$ is the set $T_1$ of sentences that hold in all $\lambda$-rich models.
%
...
Finally, as in the proof of Theorem~\ref{thm_zigzagcantor}, we extend $h_{i+^1\!\!/\!_2}$ to obtain $h_{i+1}$.
 the same procedure with the roles of $M$ and $N$ inverted and with $h^{-1}_{i+^1\!\!/\!_2}$ for $h_i$.
