...
When partial isomorphisms between models of a given theory $T$ coincide with elementary maps, it is always by a fundamental reason.
...
For instance we rephrase Corollary~\ref{coroll_tutteleimmersionisonoelementari_QE} by saying that $T_{\rm dlo}$ and $T_{\rm rg}$ have elimination of quantifiers.
