...
Show that $N$ is homogeneous if morphisms are elementary maps, but that this is not true if morphisms are simply partial isomorphisms.
\end{exercise}
...
Work in the category of models of $T_0$ and partial isomorphisms.
