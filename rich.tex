...
The equivalence with \ssf{1} will be proved only in Chapter~\ref{elimination}, see Exercise~\ref{ex_prove_thm_EQ} or Corollary~\ref{corol_QE}, but it is not required in the meanwhile if you accept the theorem above as a definition of quantifier elimination.
...
\begin{itemize}
    \item[1.] $T$ has elimination of quantifiers;
    \item[2.] every finite partial isomorphism between models $T$ is an elementary map.
\end{itemize}
Hint. From what shown in this section, the equivalence holds with \textit{finite\/} replaced by $<|L|$.
Prove that this is sufficient.\QED
\end{exercise}
