...
\begin{exercise}
  ...
  Prove that $\omega$ is not an elementary of $\omega+\omega$.\QED
  \end{exercise}
...
\begin{exercise}
  ...
  \item[2.]  for every $b\in \ns X$ there is an $a\in X$ such that $a\approx b$.\QED 
  \end{itemize}
\end{exercise}
...
\begin{exercise} 
  Prove that every proper elementary extension of $\QQ$ in the language of rings plus a relation symbol for every subset of $\QQ$ has infinities and infinitesimals.\QED
\end{exercise}
...
\begin{proof}We proceed by induction on the syntax of $\phi(x)$.
...
\hspace*{18ex}\llap{$M\models \phi(a,b)$}\parbox{7ex}{\hfil$\IFF$}\parbox{15ex}{$N\models \phi(ha,hb)$} for every $a\in M^{|x|}$ and $b\in M$.
...
\begin{exercise}
  The language contains only $<$, the relation of strict order.
  Prove that there is a countable ordinal $\alpha$ that is an elemenrary substructure of $\omega_1$, the first uncountable ordinal.\QED
\end{exercise}
