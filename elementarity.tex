...
\ceq{\ssf{2$^*$}\hfill N/E\ \pmodels\ rt}{\IFF}{t^N\,E\;a}\quad for some $a\in r^N$
...
A theory $T$ is \emph{maximally consistent\/} if it is consistent and there is no consistent theory $S$ such that $S\subset T$.
...
\begin{itemize}
\item[a.]\ \parbox{6ex}{$\displaystyle\lim_{x\imp+\infty}$}\parbox{11ex}{$fx\;=+\infty$}\parbox{10ex}{\hfil$\IFF$}$\ns f(c)$ is infinito positivo for every $c>0$ infinito.

\item[b.]\ \parbox{6ex}{$\displaystyle\lim_{x\imp+\infty}$}\parbox{11ex}{$fx\;=\;l$}\parbox{10ex}{\hfil$\IFF$}$\ns f(c)\approx l$ for every $c>0$ infinito.

\item[c.]\ \parbox{6ex}{$\displaystyle\lim_{x\imp a}$}\parbox{11ex}{$fx\;=+\infty$}\parbox{10ex}{\hfil$\IFF$}$\ns f(c)$ is infinito positivo for every $c\approx a\neq c$.

\item[d.]\ \parbox{6ex}{$\displaystyle\lim_{x\imp a}$}\parbox{11ex}{$fx\;=\;l$}\parbox{10ex}{\hfil$\IFF$}$\ns f(c)\approx l$ for every for every $c\approx a\neq c$.
\end{itemize}
\end{proposition}
