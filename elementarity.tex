...
By Exercise~\ref{ex_finitanaturaeqel} above, it suffices to verify that $(0,1)\equiv_B  (0,2)$ for every finite $B\subseteq(0,1)$.
This follows again by Theorem~\ref{isomorfoeleq} as $(0,1)$ and $(0,2)$ are $B$-isomorphic for every finite $B\subseteq(0,1)$.
\end{example}
...
\begin{proof}[Second proof of the downward L\"owenheim-Skolem Theorem]
  \label{diym_II_thm_lowenheimskolemallingiu}\rm
...
\begin{exercise}\label{ex_elem_sub_of_omega1}
  The language contains only $<$, the relation of strict order.
  Prove that there is a countable ordinal $\alpha$ that is an elemenrary substructure of $\omega_1$, the first uncountable ordinal.
\end{exercise}
