...
In this section we adopt the setting of Section~\ref{definablegroups}, that is, $G=\grZ$~--~with the same definablity conditions.
Here we also assume that the action is transitive and that the formula $\phi({\mr x}\,{\gr z})$ defined in Section~\ref{definablegroups} is stable.
