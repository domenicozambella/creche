...
\begin{corollary}\label{corol_stable_coheir_over_models}
  ...
  Let $q({\mr x})\subseteq L_\phi(\U)$ be finitely satisfiable in every $M\subseteq A$..
...
\begin{proof}
  ...
  \ssf2$\IMP$\ssf1.
  From \ssf2 it follows that $\phi({\mr a}\,;{\gr z})$ is contained in a global type $p({\gr z})$ Lascar invariant over $A$.
