...
\begin{proof}
  Inclusion $\supseteq$ holds in general by Proposition~\ref{prop_Z0_inclusione}.
  To prove the converse inclusion pick ${\gr g}\in\grZ$ such that $\mrD\cap{\gr g}{\cdot}\mrD=\varnothing$ for some $\BDelta(\grZ)$-definable $\grZ$-generic set $\mrD$.
