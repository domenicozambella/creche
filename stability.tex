...
\begin{corollary}\label{corol_harrington0}
  ...
  Suppose there exist $\mrA\subseteq\U^{\mr x}$ and $\grB\subseteq\U^{\gr z}$ that are boolean combinations of sets of the form $\phi(\U^{\mr x}\,;{\gr b'})$ for ${\gr b'}\in M^{\gr z}$, respectively of the form $\phi({\mr a'}\,;\U^{\gr z})$ for  ${\mr a'}\in M^{\mr x}$, such that\smallskip
...
The sets $\Delta$ and $A$ are to be inferred from the context.
...
\begin{theorem}[ (Stationarity)]\label{thm_stationarity}
  ...
  Assume $q({\mr x})$ decides all Boolean combinations of formulas in $\Delta(\U^{\gr z})$ that are invariant over $\acl^\eq\!A$.
