...
\begin{exercise}
Let $T$ be strongly minimal and let $\phi({\mr x}\,;{\mr y})\in L(A)$ with $|{\mr z}|=1$. For arbitrary $c\in\U$, prove that if the orbit of $\phi({\mr\U}\,; {\mr c})$ over $A$ is finite, then $\phi({\mr\U}\,; {\mr c})$ is definable over $\acl A$. 
