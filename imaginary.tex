...
For legibility, we pretend that all formulas $\sigma$ depend on the same variables. so we assume that ${\mr x}\,;{\gr z}$ are infinite tuples. Hence, with the notation of the previous section $L_{\rm srt}=\{0\}\cup L_{{\mr x}\,;{\gr z}}$.
