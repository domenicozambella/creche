...
Prove that there is a finite equivalence relation definable over $A$ that coincides with $\phi({\mr x}\,;{\mr y})$ on $p({\mr\U})$.
\end{exercise}
...
\begin{exercise}
  ...
  For arbitrary ${\gr c}\in\U^{\gr z}$, prove that if the orbit of $\phi({\mr\U}\,; {\gr c})$ over $A$ is finite, then $\phi({\mr\U}\,; {\gr c})$ is definable over $\acl A$.
  \end{exercise}
