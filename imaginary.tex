...
for some tuple ${\gr b}$ of elements of $\acl\{{\vl\Aa}\}$.  Fix some algebraic formula $\delta({\gr z}\,;{\vl\Aa})$ satisfied by  ${\gr b}$ and write $\psi({\gr z}\,;{\vl\X})$ for the formula
...
\begin{proof}
Let ${\vl\Aa}\in\U^\eq$ be a definable set and let $\sigma({\mr x}\,;{\gr z})$ be its sort. Then $\A{\mr x}\ \big[{\mr x}\in{\vl\Aa}\iff\sigma({\mr x}\,;{\gr z})\big]$ is consistent and, by $\,\sharp\,$ it  it has a solution in $\acl\{{\vl\Aa}\}$. Hence weak elimination follows from Theorem~\ref{elimimd}.
\end{proof}
