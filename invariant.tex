...
Stationarity is often ensured by the following property, which will receive due attention in Section~\hyperref[stable_theories]{\ref*{stability}.\ref*{stable_theories}}. Recall that for $\D,\C\subseteq\U$ we write $\D=_A\C$ for $\D\cap A=\C\cap A$.
