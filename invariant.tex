...
Stationarity is often ensured by the following property, which will receive due attention in Section~\hyperref[stable_theories]{\ref*{stability}.\ref*{stable_theories}}. 
