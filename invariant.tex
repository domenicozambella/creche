...
\begin{proof}
  ...
  \ceq{\hfill q(x)}{\cup}{\Big\{\phi(x_{\restriction I_0})\iff\phi(x_{\restriction J_0})\ :\  \phi(x_{\restriction n})\in L(A),  I_0\in{I\choose n},  J_0\in{J\choose n}, n<\omega\Big\}.}
  ...
  \ceq{\hfill p(z)}{=}{\Big\{\phi(z_{\restriction J_0})\in L(A)\ :\ \phi(b_{\restriction n})\ \textrm{ for some }J_0\subseteq{J\choose n},\ n<\omega\Big\}.}
...
\begin{exercise}
Let  $p({\mr x})\in S(\U)$ be a global type invariant over $A$. Let ${\mr a}$ and ${\mr b}$ two realizations of $p_{\restriction A}({\mr x})$. Prove that there is a sequence $c=\<{\mr c_i}:i<\omega\>$ such that ${\mr a},c$ and ${\mr b},c$ are both sequences of $A\jj$indiscernibles.\QED
\end{exercise}
% 
