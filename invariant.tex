...
A global $\phi$-type can be identified with $\D_{p,\phi}$ and a global type can be identified with the collection of all these sets. The notions of invariance coincide.
