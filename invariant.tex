...
\begin{exercise}
Let  $p({ x})\in S(\U)$ be a global type invariant over $A$. Let ${ a}$ and ${ b}$ two realizations of $p_{\restriction A}({ x})$. Prove that there is a sequence $c=\<{ c_i}:i<\omega\>$ such that ${ a},c$ and ${ b},c$ are both sequences of $A\jj$indiscernibles.\QED
\end{exercise}
% 
