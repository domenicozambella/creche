...
We call this the \emph{heir/coheir} relation. The symbol $\nonforkc$ is not standard. More properly one says that $\tp({\gr a}/A,{\mr b})$ is the heir of $\tp({\gr a}/A)$ or that $\tp({\mr b}/A,{\gr a})$ is the coheir of $\tp({\mr b}/A)$.
