...
\begin{proof}
  ...
  By Lemma~\ref{indipendenza+1} $B\sm b, a$ is an independent set.
  Therefore, by what proved above, it is contained in a base $B'$.
  As $|B'\sm A|<|B\sm A|$, we have a contradiction.
\end{proof}
