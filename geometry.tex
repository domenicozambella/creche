...
\begin{theorem} 
($T$ strongly minimal.) Independence is symmetric. That is, if ${\mr a},{\mr b}\notin\acl B$ then ${\mr b}\in\acl (B,{\mr a})\IFF{\mr a}\in\acl(B,{\mr b})$
\end{theorem} 
...
We say that $B\subseteq C$ is a \emph{basis\/} of $C$ if $B$ is an independent set and $C\subseteq\acl B$. The following theorem proves that all bases have the same cardinality, which we call the  \emph{dimension\/} of $C$ and denote by \emph{$\dim C$}. First we need the following lemma.
