...
If ${\mr b}\in\acl(\dom k)$ the required extension exists by Proposition~\ref{prop_estensionemappechiusuraalgebrica}.
Otherwise, pick any ${\mr c}\in N\sm\acl(\range k)$, which exist as $|k|<\dim N=|N|$.
By Proposition~\ref{prop_mappetraindipendenti},  $k\cup\big\{\<{\mr b},{\mr c}\>\big\}$ is the required extension.
