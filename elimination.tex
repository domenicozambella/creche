...
In this chapter we present a few results dating from the 1950s that describe the relationship between syntactic and semantic properties of first-order formulas. These results describe syntactically formulas that preserved under various sorts of morphisms. Criteria for quantifier-elimination follow from these theorems, see for instance the frequently used back-and-forth method of Corollary~\ref{corol_QE_back_and_forth}.
