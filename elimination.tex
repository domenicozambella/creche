...
Let $L$ be the language of strict orders. The theory of \emph{discrete linear orders\/} extends the theory of linear orders without endpoints (see Section~\hyperref[dlo]{\ref*{relational}.\ref*{dlo}}) with the following two of axioms
\begin{itemize}
