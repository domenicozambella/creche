...
Let $T$ be the theory of \emph{discrete linear orders}. Namely, $T$ extends the theory of linear orders $T_{\rm lo}$  (see Section~\hyperref[dlo]{\ref*{relational}.\ref*{dlo}}) with the following two of axioms with the following two of axioms
\begin{itemize}
...
Model-completeness is equivalent to a sort of quantifier elimination.
