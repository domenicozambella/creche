...
This is sametime called \textit{local\/} stability.
For simplicity, here we assume that all formulas are stable.

\begin{theorem}\label{thm_symmetry}
  ($T$ stable) For every $M,{\mr a},{\gr b}$ 

  \ceq{\hfill{\mr a}\cnonfork_M{\gr b}}{\IFF}{{\gr b}\cnonfork_M{\mr a}}
\end{theorem}

\begin{proof}
  Assume ${\mr a}\cnonfork_M{\gr b}$ and $\phi({\mr a},{\gr b})$ for some $\phi({\mr x},{\gr z})\in L(M)$.
  We prove that $\phi({\mr a},{\gr z})$ is satisfied in $M$.
