...
\ssf{1}$\IMP$\ssf{4} Assume $\phi({\mr x}\,;{\gr z})$ has the binary tree property as witnessed by  $\<{\gr b_s}:s\in 2^{<\omega}\>$. 

We show that there is a ladder sequence of length $n$. For $i=0,\dots, n$ abbreviate ${\gr b_{1^i}}$ by ${\gr b_i}$. Let ${\mr a_j}$ be such that
