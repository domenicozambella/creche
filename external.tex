...
The following property of definability seems to go in the reverse directions.
This has an application in ...

\begin{proposition}
  Let $\phi({\mr x}\,;{\gr z})\in L(\U)$ be stable.
  Let $M$ and ${\mr a}\in\U^{\mr x}$ be arbitrary.
  Then, for some ${\mr a_1}\equiv_M\dots\equiv_M{\mr a_n}$, some positive Boolean combination of the sets $\phi({\mr a_i}\,;\U^{\gr z})$ is definable over $M$.
\end{proposition}
...
\begin{proposition}
  ...
  Then, for some ${\mr a_1}\equiv_A\dots\equiv_A{\mr a_n}$, some positive Boolean combination of the sets $\phi({\mr a_i}\,;\U^{\gr z})$ is definable over $A$.
\end{proposition}
...
\begin{proof}
  ...
  Let $\theta({\mr a_1},\dots,{\mr a_n}\,;\V^{\gr z})=\phi({\mr a}\,;\V^{\gr z})$ be such a Boolean combination.
  By Theorem~\ref{}, we can choose $\V$ containing $A$ and such that every formula $\phi({\mr x})\in\tp({\mr a}/\V)$ is satisfied in every model containing $A$.
  It follows that ${\gr b}\equiv_{A,a}{\gr b'}$ for every ${\gr b}\equiv_A{\gr b'}$ in $\V$.
  Then 
\end{proof}
