...
The proof is exactly the same, in fact elementarity and saturation are never used (to a great extent, no model theory is used either).\QED%, see Section~\hyperref[stability_combinatorics]{\ref*{combinatorics}.\ref*{stability_combinatorics}}).
\end{remark}
