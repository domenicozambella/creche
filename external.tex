...
\ceq{\hfill {\gr z}\in\grD}{\iff}{\bigvee^{n-1}_{i=0}\phi({\mr a_i}\,;{\gr z})}

for some ${\mr a_0},\dots,{\mr a_n}\in\U^{|{\mr x}|}$. 
\end{lemma}

\begin{proof}
Pick any ${\gr b_0}\in\grD$. Choose ${\mr a_n}\in\U^{|{\mr x}|}$ such that ${\gr b_0},\dots,{\gr b_{n-1}}\in\phi({\mr a_n}\,;{\gr\U})\subseteq\grD$.
...
It suffices to prove that there are some ${\mr a_0},\dots,{\mr a_m}$ such that ${\gr B}\subseteq\psi({\mr a_0},\dots,{\mr a_m}\,;{\gr\U})\subseteq\grD$. Choose ${\mr a_n}\in\U^{|{\mr x}|}$ such that 
