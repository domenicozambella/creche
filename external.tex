...
The following proposition highlights the connection between the stability of and  $\phi({\mr x}\,;{\gr z})$ and the cardinality of $S_\phi(\U)$, equivalently the number of sets externally definable by $\phi({\mr x}\,;{\gr z})$. 
...
\begin{proof}
  ...
  Let $p(\gr z)\in S_\phi(\U)$ be invariant over $\acl^\eq\!A$ and consistent with $\tp(b/\acl^\eq\!A)$.
