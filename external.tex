...
For instance, the formula ${\gr z_1}<{\mr x}<{\gr z_2}$ in $T_{\rm dlo}$ has VC-dimension $2$.
...
\begin{proof}
\ssf{1}$\IMP$\ssf{2} Assume $\neg$\ssf{2} and let $n<\omega$ be an arbitrary finite ordinal. It suffices to prove that for every $I\subseteq n$ the formula $\psi_{I}({\mr a_0},\dots,{\mr a_{n-1}}\,;{\gr z} )$ that says 

\ceq{\hfill\phi({\mr a_i}\,;{\gr z})}{\IFF}{i\in I}

is consistent. If there is a ${\gr b}$ such that the truth value of $\<\phi({\mr a_i}\,;{\gr b}):i<\omega\>$ oscillates at least $n$ times, then we can find $k_0<\dots<k_{n-1}$ such that 

\ceq{\hfill \phi({\mr a_{k_i}}\,;{\gr b})}{\IFF}{i\in I.}

Then the formula $\psi_{I}({\mr a_{k_0}},\dots,{\mr a_{k_{n-1}}}\,;{\gr z})$ is consistent. Therefore, by indiscernibility, also the formula  $\psi_{I}({\mr a_0},\dots,{\mr a_{n-1}}\,;{\gr z} )$ is consistent.
...
Let  $\<{\mr a_i}:i<\omega\>$ be an indiscernible sequence that models the EM-type of $\<{\mr c_i}:i<\omega\>$. Then $\<{\mr a_i}:i<\omega\>$ satisfies $\E{\gr z}\,\psi_{I\restriction n}({\mr x_0},\dots,{\mr x_{n-1}}\,;{\gr z})$ for all $n$. By compactness there is a $b$ such that
