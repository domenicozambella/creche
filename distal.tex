...
\begin{corollary}[(Strong Erd\H os-Hajnal Property for distal relations)] If $\phi({\mr x}\,;{\gr z})$ is distal, then for every $\alpha\in(0,1/2)$ there is a $\beta\in(0,1)$ such that for every finite ${\mr A}\subseteq\mrU$ and ${\gr B}\subseteq\grV$ there are ${\mr A_0}\subseteq{\mr A}$ and ${\gr B_0}\subseteq{\gr B}$ such that $|{\mr A_0}|\ge\alpha|{\mr A}|$ and $|{\gr B_0}|\ge\beta|{\gr B}|$ and ${\mr A_0}{\times}{\gr B_0}$ is either contained in or disjoint of $\phi$.
\end{corollary}

\begin{proof}
Let $\epsilon=1-2\alpha$. Let $\big\{{\gr c_1},\dots{\gr c_t}\big\}\subseteq\grV$ be an $\epsilon$-dense set for $\phi({\mr A};\,{\gr z})$ for some $t\le t_\epsilon$. Let ${\mr C_i}\subseteq{\mr A}$ be as in the definition above. Let $\beta=1/t_\epsilon$. Then there is an $i$ such that $\phi({\mr C_i};\,{\gr b})=\phi({\mr C_i};\,{\gr c_i})$ holds for at least
