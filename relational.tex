...
\begin{exercise}
Prove that $T_{\rm dlo}$ is not $\lambda$-categorical for any uncountable $\lambda$.\QED
\end{exercise}
...
Is every random graph $M\subseteq N$ of the form $\phi(N)$ for some $\phi(x)\in L(N)$~?\QED
\end{exercise}
...
Axiomatize the class of graphs that are free union of two random graphs.\QED
\end{exercise}
...
\begin{exercise}
Let $N\models T_{\rm rg}$ and let $\phi(x)\in L(N)$, where $|x|=1$.
Prove that for some finite sets $A,B,C,D\subseteq N$  the following holds in $N$

\ceq{\hfill \phi(x)\quad}
{\iff}
{\quad\bigwedge_{a\in A}r(x,a)\ \wedge\ \bigwedge_{b\in B}\neg r(x,b)\ \wedge\  x\in C\ \wedge\  x\notin D}.\QED
\end{exercise}
