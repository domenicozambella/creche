...
We write $g{\cdot}\mrD$ for the natural action of $g\in G$ on $\mrD\subseteq\mrX$.
...
We revisit the notions introduced in Section~\ref{eq_algebraic} with the only difference that we apply them to $ L(\grZ)$, not to the full language.%$\LDelta(\mrX,\grZ)$.
