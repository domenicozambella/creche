...
Recall that in Section~\ref{dual_perspective} we proved that if $\gamma_H({\mr x})$ is consistent, then $H$-generic sets are $H$-wide. 
...
We will revisit the proposition and its converse implication under the assumption of stability.
...
\begin{fact}\label{fact_wideHcojugate}
  ...
  For $i=1,2$ let ${\gr h_i}\in({\gr g_i})_H$.
  The following are equivalent
  \begin{itemize}
    \item [1.] ${\gr g_1}{\cdot}\mrD\ \cap\ {\gr g_2}{\cdot}\mrD$ is $H$-wide
    \item [2.] ${\gr h_1}{\cdot}\mrD\ \cap\ {\gr h_2}{\cdot}\mrD$ is $H$-wide.
  \end{itemize}
\end{fact}

\begin{proof}
  Let $f_i\in H$ be such that ${\gr h_i}\in f_i({\gr g_i})$.
  Write $\mrC$ for the set in \ssf1.
  If $\mrC$ is $H$-wide, by Corollary~\ref{corol_intersectionGwide} also $f_1[\mrC]\,\cap\,f_2[\mrC]$ is $H$-wide.
  A fortiori $f_1[{\gr g_1}{\cdot}\mrD]\,\cap\,f_2[{\gr g_2}{\cdot}\mrD]$ is $H$-wide.
  Then \ssf1$\IMP$\ssf2 follows from Remark~\ref{rem_H}.
  By symmetry, this proves the equivalence.
\end{proof}

We write \emph{$\big\<({\gr g})_H^{-1}\!\cdot({\gr g})_H\big\>$\,} for the group generated by the set $\big\{{\gr a^{-1}}\!\cdot{\gr b}\ :\ {\gr a},{\gr b}\in({\gr g})_H\big\}$.

\begin{proposition}
  Let $\mrD=\phi(\mrX\,;{\gr 1})$ for some $\phi({\mr x}\,;{\gr z})\in\pmDelta$.
  Let ${\gr g}$ be such that $\mrD\cap{\gr g}{\cdot}\mrD$ is $H$-wide.
  Then $\mrD\cap{\gr h}{\cdot}\mrD$ is $H$-wide for every ${\gr h}\in\big\<({\gr g})_H^{-1}\!\cdot({\gr g})_H\big\>$.
\end{proposition}

\begin{proof}
  Assume inductively that $\mrD\cap{\gr h}{\cdot}\mrD$ is $H$-wide, where ${\gr h}\in\big\<({\gr g})_H^{-1}\!\cdot({\gr g})_H\big\>$.
  Pick two arbitrary ${\gr a},{\gr b}\in({\gr g})_H$.
  We claim that $\mrD\,\cap\,{\gr a^{-1}}\!\cdot{\gr b}\cdot{\gr h}\cdot\mrD$ is $H$-wide.
  From the induction hypothesis it follows that ${\gr b}\cdot\mrD\,\cap\,{\gr b}\cdot{\gr h}\cdot\mrD$ is $H$-wide.
  From Fact~\ref{fact_wideHcojugate} we obtain that ${\gr a}\cdot\mrD\,\cap\,{\gr b}\cdot{\gr h}\cdot\mrD$ is $H$-wide and the claim follows.
\end{proof}
...
\begin{comment}
̀̀A formula $\psi({\mr x})\in L$ is \emph{symmetric\/} if $\psi({\gr g}\cdot{\mr x})\iff\psi({\gr g^{-1}}\!\cdot{\mr x})$ holds for every ${\gr g}\in\grZ$.
...
When $\Psi$ is symmetric, we can strengthen Fact~\ref{fact_wideHcojugate} as follows.

\begin{fact}\label{fact_wideHcojugate_symm}
  Let $\mrD=\phi(\mrX\,;{\gr 1})$ for some $\phi({\mr x}\,;{\gr z})\in\pmDelta$.
  For $i=1,2$ let ${\gr h_i}\in({\gr g_i})_K$. 
  Then \ssf1 and \ssf2 of Fact~\ref{fact_wideHcojugate} are equivalent
\end{fact}
...
\begin{proof}
  ...
  By Fact~\ref{fact_wideHcojugate}, \ssf2 is equivalent to claiming that ${\gr g_1}{\cdot}\mrD\ \cap\ {\gr g_2^{-1}}{\cdot}\mrD$ is $H$-wide. 
...
\begin{proof}
  ...
  By Fact~\ref{fact_wideHcojugate_symm}, ${\gr a^{-1}}{\cdot}\mrD\cap{\gr b}{\cdot}{\gr g'}{\cdot}\mrD$ is $H$-wide and the claim follows.
\end{proof}
\end{comment}
