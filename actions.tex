...
\ceq{\ssf{it1.}\hfill\theta({\mr x}\,;{\gr\bar a})\in p}{\IFF}{\theta({\mr x}\,;g\,{\gr\bar a})\in p}\hfill for every $g\in G$ and every $\theta({\mr x}\,;{\gr\bar a})\in\qfDelta(\grZ)$.
...
\ceq{\hfill p({\mr x})\proves{\mr x}\in\mrD}{\IFF}{p({\mr x})\proves{\mr x}\in g{\cdot}\mrD}\hfill for every $\qfDelta({\grZ})$-definable $\mrD$ and $g\in G$.
...
\ceq{\hfill\emph{${}^{\rm s}\kern-.2ex\gamma_G({\mr x})$}}{=}{\{\theta({\mr x})\in \qfDelta({\grZ}): \theta({\mr x})\textrm{ is strong }G\textrm{-generic}\}}
...
\begin{definition}\label{def_G0}\noindent\vspace*{0.1ex}
  ...
  \ceq{\ssf1.\hfill{\gr\Z^0}}{=}{\bigcap\big\{\grW\le\grZ\ :\ \textrm{ stabilizer of a }\qfDelta(\grZ)\textrm{-definable set with finite $\grZ$-orbit}\big\}}.\smallskip
...
\begin{proposition}\label{prop_Z0_inclusione1}
  Assume $\gamma_{\Z^0}({\mr x})$ is finitely consistent.
  Then                            

  \ceq{\hfill{\gr\Z^0}}{\subseteq}{\big\{{\gr g}\in\grZ\ :\ \mrD\cap{\gr g}{\cdot}\mrD\neq\varnothing\textrm{ for every }\qfDelta(\grZ)\textrm{-definable }\grZ\textrm{-generic set }\mrD\big\}}.
...
\begin{proof}
  By Proposition~\ref{prop_Ggeneric_Hpersistent}, any $\grZ$-generic set $\mrD$ is $\gr\Z^0$-wide.
...
\begin{proof}
  ...
  If $\grW$ is the stabilizer of a set with finite orbit, then $\grW$ has finite index.
  Then $\grW{\cdot}{\mr a}$ is $G$-generic for any ${\mr a}\in\mrX$.
  Then $\grW{\cdot}{\mr a}\cap{\gr g}{\cdot}\grW{\cdot}{\mr a}\neq\varnothing$.
  Let ${\gr h},{\gr k}\in\grW$ be such that ${\gr h}{\cdot}{\mr a}={\gr g}{\cdot}{\gr k}{\cdot}{\mr a}$.
  It follows that ${\gr h}={\gr g}{\cdot}{\gr k}$, then ${\gr g}\in\grW$.
 \end{proof}
