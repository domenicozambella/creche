...
A set $\mrY\subseteq\mrX$ is \emph{$G$-minimal\/} if $G{\cdot}\mrY=\mrX$ covers $\mrX$ and for every $g\in G$ either $g{\cdot}\mrY=\mrY$ or $\mrY\cap g{\cdot}\mrY=\varnothing$.

\begin{definition}\label{def_G00}
  Let $\Phi^0$ be the collection of $\Delta(\grZ)$-definable, $G$-minimal sets that have finite orbits covering $\mrX$.
  Let $\Phi^{00}$ be the collection of $\Delta(\grZ)$-type-definable, $G$-minimal sets that have a bounded $G$-orbit covering $\mrX$
  Define\smallskip
...
\begin{proposition}
  Assume that $\mrX$ is $\Delta(\grZ)$-type-definable.
  Then 
...
In this section $\grZ$ is a definable sets.
We assume that $\grZ$ is a group and that the operation on $\grZ$, which will be denoted by denoted by $\cdot$, is definable.
