...
\begin{corollary}\label{corol_intersectionGwide}
  ...
  Then for every $g\in G$ also $\mrD\cap g\cdot\mrD$ is $G$ wide.
\end{corollary}
...
\begin{proof}
  Suppose $\gamma_G({\mr x})\proves{\mr x}\in(\mrD\cup g\,\mrD)$.
...
It is easy to verify that $\grZ$ is a normal.
...
\begin{proposition}\label{prop_Ggeneric_persistent}
  Assume that $\gamma_H({\mr x})$ is consistent.
  Then \ssf1$\IMP$\ssf2 for every $\phi({\mr x}\,;{\gr z})\in\Delta$, where
  \begin{itemize}
...
\begin{fact}\label{fact_wideHcojugate}
  Let $\mrD\subseteq\mrX$ be $\BDelta({\grZ})$-definable and $H$-invariant.
  Let ${\gr h},{\gr h'}\in\grZ$ be $H$-conjugate.
...
\begin{proof}
  Let $f\in H$ be such that $f[{\gr h}]={\gr h'}$.
  Assume \ssf1 then by Corollary~\ref{corol_intersectionGwide} also ${\gr g}{\cdot}\mrD\,\cap\,{\gr h}{\cdot}\mrD\,\cap\, f[{\gr g}{\cdot}\mrD]\,\cap\, f[{\gr h}{\cdot}\mrD]$ is $H$-wide.
  A fortiori ${\gr g}{\cdot}\mrD\,\cap\, f[{\gr h}{\cdot}\mrD]$ is $H$-wide.
  As $\mrD$ is $H$-invariant, ${\gr g}{\cdot}\mrD\,\cap\,{\gr h'}{\cdot}\mrD={\gr g}{\cdot}\mrD\,\cap\, f[{\gr h}{\cdot}\mrD]$.
  Then \ssf1$\IMP$\ssf2 follows and, by symmetry, also \ssf2$\IMP$\ssf1.
\end{proof}
̀̀́
For any $\mrD\subseteq\mrX$, we define 

\ceq{\hfill\emph{${\gr\St_H}(\mrD)$}}{=}{\{{\gr g}\in\grZ\ :\ \mrD\cap{\gr g}\cdot\mrD \textrm{ is } H\textrm{-wide}\}}

\begin{fact}
  Let $\mrD\subseteq\mrX$ be $\BDelta({\grZ})$-definable, $H$-invariant, and $H$-wide.
  Let ${\gr g},{\gr h}\in\grZ$ be $H$-conjugate.
