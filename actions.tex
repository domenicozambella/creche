...
\begin{definition}\label{def_G0}\noindent\vspace*{0.1ex}
  ...
  \ceq{\ssf1.\hfill{\gr\Z^0}}{=}{\bigcap\big\{\grW\le\grZ\ :\ \grW\textrm{ is }\BDelta(\mrX)\textrm{-definable and has finite index in }\grZ\big\}}.\smallskip
...
\begin{proof}
  ...
  As $\grW$ has finite index, $\grW{\cdot}{\mr a}$ is $G$-generic for any ${\mr a}\in\mrX$.
