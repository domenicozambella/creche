...
We will revisit this proposition and its converse implication under the assumption of stability.
...
\begin{proposition}\label{prop_wideHcojugate}
  Let $\theta({\mr x}\,;{\gr z_1},\dots,{\gr z_n})$ be a formula in $\BDelta$.
...
\begin{proof}
  ...
  Without loss of generality we can assume that $\theta({\mr x}\,;{\gr g_1},\dots,{\gr g_n})$ is the conjunction of the formulas $\phi_i({\mr x}\,;{\gr g_i})$ for some $\phi_i({\mr x}\,;{\gr z})\in\Delta$
...
% \begin{fact}\label{prop_wideHcojugate}
...
\begin{proposition}
  ...
  Assume that the formula $\theta({\mr x}\,;{\gr 1},\dots,{\gr 1})$ is $H$-wide.
  Then $\theta({\mr x}\,;{\gr h_1},\dots,{\gr h_n})$ is $H$-wide for every ${\gr h_i}\in\big\<({\gr g})_H^{-1}\!\cdot({\gr g})_H\big\>$.
\end{proposition}

\begin{proof}
  We proceed by induction on the total number of factors ${\gr a^{-1}}\!\cdot{\gr b}$, for some ${\gr a},{\gr b}\in({\gr g})_H$, that occur in ${\gr h_1},\dots,{\gr h_n}$.
...
%   From Fact~\ref{prop_wideHcojugate} we obtain that ${\gr a}\cdot\mrD\,\cap\,{\gr b}\cdot{\gr h}\cdot\mrD$ is $H$-wide and the claim follows.
% \end{proof}
