...
\ceq{\hfill r^M}{=}{\big\{\<a_1,\dots,a_n\>\in M^{n_r}\ :\ r(a_1,\dots,a_n)\in T\big\}.}

Define for every function symbol $f$

\ceq{\hfill f^M}{=}{\big\{\<a_1,\dots,a_n,t\>\in M^{n_f+1}\ :\ t=fa_1\dots a_n\big\}.}
...
Write $T_{\rm gph}$ for the theory of graphs, see Example~\ref{expl_Tgraphs}.
