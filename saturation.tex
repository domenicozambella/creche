...
Prove that $M$ has an $\omega\mbox{-}$homogeneous elementary extension of the same cardinality.\QED 
\end{exercise}
...
Prove that the two structures are isomorphic.\QED 
\end{exercise}
...
Exhibit a countable saturated model and a countable model that is not homogeneous.\QED 
\end{exercise}
...
Show that this is not true if $x$ has length $\omega$.\QED 
\end{exercise}
...
\begin{exercise}
  ...
  \begin{itemize}
    ...
    \item[2.] $\phi_{n+1}(x)\wedge\phi_{n+1}(y)\ \imp\ \phi_n(x\cdot y)$.\QED
  \end{itemize}  
\end{exercise}
\end{document}