...
\begin{exercise}\label{ex_bfc_groups}
  ...
  \end{itemize}
  A group $G$ is {\sc bfc} (has boundedly finite conjugacy classes) if for some $n$ the sets $\{gag^{-1}:g\in G\}$, as $a$ ranges over $G$, have at most $n$ elements. Hint: implication \ssf2$\IMP$\ssf1 requires the B.H. Neumann's {\sc bfc}-Theorem
\end{exercise}