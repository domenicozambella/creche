...
When the morphisms of the underlying category are the elementary maps, it is usual to replace the notion of $\lambda\mbox{-}$universal (cfr.\@ Definition~\ref{def_weakly_universal}) with the following.
