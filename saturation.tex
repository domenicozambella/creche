...
\begin{remark}
For the reader who did not read Section~\hyperref[rich]{\ref*{fraisse}.\ref*{rich}}. Replace \ssf{2} below with the following, and forget about $\M$.
\begin{itemize}
...
A definable set has the form $\phi({\mr\U}\,;{\gr b})$ for some formula $\phi({\mr x}\,;{\gr z})\in L$ and some ${\gr b}\in\U^{|{\gr z}|}$. If $f\in\Aut(\U)$ then 
