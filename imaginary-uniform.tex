...
\begin{itemize}
\item[1.] $T$ has uniform elimination of imaginaries
\item[2.] $\dcl\varnothing$ contains at least two elements and $T$ has elimination of imaginaries.
\end{itemize}
\end{theorem}
...
The witnesses of $\E^{=1} {\gr z}$ in these two formulas are two distinct elements of $\dcl\varnothing$.
...
Fix some distinct $\varnothing$-definable tuples $d_0,\dots, d_n$ of the same length (these are easy to obtain from two $\varnothing$-definable elements).
