...
\begin{proof}
  ...
  %
  Then there are two models $\<A\>_M\subseteq N_i\models T_{\rm oid}$, some ${\mr b_i}\in N_i$, a polynomial $t({\mr x}\,;{\gr z})$ and some ${\gr a}\in\big(\<A\>_M\big)^{|{\gr z}|}$ such that 
  \begin{itemize}
  \item[a$'$.] $N_1\models \phi({\mr b_1})$ \ and \ $N_1\models t({\mr b_1}\,;{\gr a})>0$;
  \item[b$'$.] $N_2\models \phi({\mr b_2})$ \ and \ $N_2\models t({\mr b_2}\,;{\gr a}) < 0$.
  %
